...
address: "The Inn at Virginia Tech and Skelton Conference Center, 901 Prices Fork Road, Blacksburg, VA, 24061, Solitude Room"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "37.2284"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-80.4234"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "September 9-10, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:00 am - 1:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
{% comment %}
AUDIENCE
This workshop is intended for faculty (including postdocs) at Virginia Tech who are interested in improving their skills in Jupyter Notebooks and GitHub. 
{% endcomment %}
{% if site.carpentry == "swc" %}
...
<p>
  Please refer to the Virginia Tech Canvas PDN page. 
</p>
{% else %}
